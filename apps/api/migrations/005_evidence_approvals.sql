...
CREATE INDEX idx_evidence_documents_org_batch ON evidence_documents(organization_id, material_batch_id);
CREATE INDEX idx_evidence_records_org_document_batch ON evidence_records(organization_id, document_id, material_batch_id);
CREATE INDEX idx_claims_org_batch_status ON claims(organization_id, material_batch_id, status);
CREATE INDEX idx_claim_evidence_org_claim ON claim_evidence(organization_id, claim_id);
CREATE INDEX idx_approval_requests_org_state ON approval_requests(organization_id, state);
CREATE INDEX idx_approval_decisions_org_request ON approval_decisions(organization_id, approval_request_id);