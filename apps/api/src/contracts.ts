/**
 * API copy of shared EARTH contracts.
 *
 * Canonical source: packages/earth-contracts/src/index.ts
 * Spec: docs/SHARED_CONTRACTS.md
 *
 * Duplicated here because earth-api compiles with NodeNext + rootDir `src`
 * and cannot import files outside this package. Freeze tests fail CI if
 * spelling or array order drifts from the spec / SPA copy.
 *
 * Literals only — no LLM, NanoChat client, Roboflow, Tinker, or blockchain.
 */
